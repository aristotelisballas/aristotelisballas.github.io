...
import { Github, BookOpen, ExternalLink, Mail, Linkedin, Terminal, ChevronDown, Video, Cpu, Globe, Award, Briefcase, GraduationCap, FileText, Calendar, Bell } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        // Reduced velocity for slower animation (0.2 instead of 0.5)
      ...
      update() {
        ...
        if (mouse.x != null) {
          ...
          if (distance < mouseDistance) {
            ...
            const directionX = forceDirectionX * force * 1; // Repulsion strength
...
const NEWS_ITEMS = [
  {
    ...
    desc: "Our 'Gradient-Guided Annealing for Domain Generalization' paper has has been accepted in CVRP2025!"
  },
  {
    date: "Dec 2024",
    ...
    <div className="min-h-screen text-slate-200 font-sans selection:bg-teal-500 selection:text-white overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-16 text-center">
        <div className="max-w-4xl z-10 animate-fade-in-up flex flex-col items-center">
          ...
          {/* <h2 className="text-teal-400 font-medium tracking-[0.2em] mb-4 uppercase">Academic Portfolio</h2> */}
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => scrollTo('research')} className="px-8 py-3 bg-teal-500 hover:bg-teal-600 text-slate-900 font-bold rounded-full transition-all transform hover:scale-105">
              Publications
            </button>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {NEWS_ITEMS.map((item, idx) => (
              <div key={idx} className="bg-slate-800/40 border border-slate-700/50 p-6 rounded-lg hover:border-teal-500/30 transition-all">
      ...
      <section id="about" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          {/* Changed grid-cols to include lg:grid-cols-3 and updated spacing */}
            ...
            <div className="h-full">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50">
                <p className="text-slate-300 mb-6 leading-relaxed text-sm">
                   ...
                   As a proud member of the HUA Robust AI Group, under the supervision of Prof. <a href="https://diou.github.io/"> Christos Diou</a>, I am interested in developing methods that can be leveraged in critical domains like Healthcare.
                </p>
              ...
              <div className="space-y-8 border-l border-slate-700 ml-3 pl-8 relative">
                {ACADEMIC_EXPERIENCE.map((exp, idx) => (
                  <div key={idx} className="relative">
                    ...
                    <p className="text-teal-400 text-xs font-medium mb-1">{exp.sup}</p>
                    <p className="text-teal-400 text-xs font-medium mb-1">{exp.grade}</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div>
              ...
              {/*<p className="text-slate-400">European Grants & Technical Implementation</p>*/}
            </div>
          </div>
